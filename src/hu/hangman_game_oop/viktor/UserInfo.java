...
class UserInfo {
	...
	void adviseRules() {
		System.out.printf("%nYou have to guess a word in each session.\r\n"
				...
				+ "For the yes-no questions, every word evaluates to true, which does not start with the letter 'n'!\r\n"
				+"If you want to give up, please press *!", Constants.getMaxNumWrongTips());
	}
